...
# Answer:
print(paste("There are total of",x," variables and",y," observations in this data set."))
...
```{r}
# Enter your code here!
mpg4 <- mean(mtcars$mpg[mtcars$cyl==4])
mpg6 <- mean(mtcars$mpg[mtcars$cyl==6])
mpg8 <- mean(mtcars$mpg[mtcars$cyl==8])
average_mpg <- c(mpg4,mpg6,mpg8)
average_mpg 
cyl_class <- c(4,6,8)
cyl_class
...
print("correlation (positif) between number of Murder and the number of Assault.")
